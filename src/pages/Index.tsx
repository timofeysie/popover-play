import { Menu, X, BookOpen, Code2, Zap, ExternalLink } from "lucide-react";

const exercises = [
  { title: "Native Popover", active: true },
  { title: "Dialog Element", active: false },
  { title: "CSS Nesting", active: false },
  { title: "View Transitions", active: false },
];
